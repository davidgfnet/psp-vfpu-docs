...
int run_vmone_p(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 1; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      asm volatile(".word 0xf3870090" ::: "memory");
      ...
      if (mm) {
        ...
        static const struct test_decl_info iinfo = {.inst = "vmone.p",
                                                    .instw = 0xf3870090,
                                                    .pfxw = 0xde000f00,
                                                    .rdoutsz = 4,
                                                    .inputs = {}};
...
int run_vmone_t(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 1; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      asm volatile(".word 0xde000f00" ::: "memory");
      asm volatile(".word 0xf3878010" ::: "memory");
      asm volatile("sv.s S400, 0*4(%0)" ::"r"(&rd_out[0]));
      asm volatile("sv.s S401, 1*4(%0)" ::"r"(&rd_out[0]));
      ...
      if (mm) {
        struct test_error_info *rep = &pfxinfo->rd_msk_err;
        static const struct test_decl_info iinfo = {.inst = "vmone.t",
                                                    .instw = 0xf3878010,
                                                    .pfxw = 0xde000f00,
                                                    .rdoutsz = 9,
                                                    .inputs = {}};
...
int run_vmone_q(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 1; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      asm volatile(".word 0xde000f00" ::: "memory");
      asm volatile(".word 0xf3878090" ::: "memory");
      asm volatile("sv.s S400, 0*4(%0)" ::"r"(&rd_out[0]));
      asm volatile("sv.s S401, 1*4(%0)" ::"r"(&rd_out[0]));
      asm volatile("sv.s S402, 2*4(%0)" ::"r"(&rd_out[0]));
      ...
      if (mm) {
        struct test_error_info *rep = &pfxinfo->rd_msk_err;
        static const struct test_decl_info iinfo = {.inst = "vmone.q",
                                                    .instw = 0xf3878090,
                                                    .pfxw = 0xde000f00,
                                                    .rdoutsz = 16,
                                                    .inputs = {}};
