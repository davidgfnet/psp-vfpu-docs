...
int run_vmidt_p(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 1; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      asm volatile(".word 0xf3830090" ::: "memory");
      ...
      if (mm) {
        ...
        static const struct test_decl_info iinfo = {.inst = "vmidt.p",
                                                    .instw = 0xf3830090,
                                                    .pfxw = 0xde000f00,
                                                    .rdoutsz = 4,
                                                    .inputs = {}};
...
int run_vmidt_t(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 1; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      asm volatile(".word 0xde000f00" ::: "memory");
      asm volatile(".word 0xf3838010" ::: "memory");
      asm volatile("sv.s S400, 0*4(%0)" ::"r"(&rd_out[0]));
      asm volatile("sv.s S401, 1*4(%0)" ::"r"(&rd_out[0]));
      ...
      if (mm) {
        struct test_error_info *rep = &pfxinfo->rd_msk_err;
        static const struct test_decl_info iinfo = {.inst = "vmidt.t",
                                                    .instw = 0xf3838010,
                                                    .pfxw = 0xde000f00,
                                                    .rdoutsz = 9,
                                                    .inputs = {}};
...
int run_vmidt_q(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 1; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      asm volatile(".word 0xde000f00" ::: "memory");
      asm volatile(".word 0xf3838090" ::: "memory");
      asm volatile("sv.s S400, 0*4(%0)" ::"r"(&rd_out[0]));
      asm volatile("sv.s S401, 1*4(%0)" ::"r"(&rd_out[0]));
      asm volatile("sv.s S402, 2*4(%0)" ::"r"(&rd_out[0]));
      ...
      if (mm) {
        struct test_error_info *rep = &pfxinfo->rd_msk_err;
        static const struct test_decl_info iinfo = {.inst = "vmidt.q",
                                                    .instw = 0xf3838090,
                                                    .pfxw = 0xde000f00,
                                                    .rdoutsz = 16,
                                                    .inputs = {}};
