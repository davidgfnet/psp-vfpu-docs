  ...
  for (unsigned i = 0; i < 128; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      rd[0] = ((rs[0 * 2 + 0] >> 3) & 0x0000001F) |
              ((rs[0 * 2 + 0] >> 5) & 0x000007E0) |
              ((rs[0 * 2 + 0] >> 8) & 0x0000F800) |
              ((rs[0 * 2 + 1] << 13) & 0x001F0000) |
              ((rs[0 * 2 + 1] << 11) & 0x07E00000) |
              ((rs[0 * 2 + 1] << 8) & 0xF8000000);
      rd[1] = ((rs[1 * 2 + 0] >> 3) & 0x0000001F) |
              ((rs[1 * 2 + 0] >> 5) & 0x000007E0) |
              ((rs[1 * 2 + 0] >> 8) & 0x0000F800) |
              ((rs[1 * 2 + 1] << 13) & 0x001F0000) |
              ((rs[1 * 2 + 1] << 11) & 0x07E00000) |
              ((rs[1 * 2 + 1] << 8) & 0xF8000000);
      ;
      unsigned int *rd_final = &rd[0]; // No dst prefix
      asm volatile(".word 0xdc000039" ::: "memory");
      asm volatile(".word 0xd05b8090" ::: "memory");
