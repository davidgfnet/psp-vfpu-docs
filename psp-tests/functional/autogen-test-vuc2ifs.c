...
int run_vuc2ifs_s(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 128; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      rd[0] = (((rs[0] >> (8 * (0 % 4))) & 0xFF) << 23) |
              (((rs[0] >> (8 * (0 % 4))) & 0xFF) << 15) |
              (((rs[0] >> (8 * (0 % 4))) & 0xFF) << 7) |
              (((rs[0] >> (8 * (0 % 4))) & 0xFF) >> 1);
      rd[1] = (((rs[0] >> (8 * (1 % 4))) & 0xFF) << 23) |
              (((rs[0] >> (8 * (1 % 4))) & 0xFF) << 15) |
              (((rs[0] >> (8 * (1 % 4))) & 0xFF) << 7) |
              (((rs[0] >> (8 * (1 % 4))) & 0xFF) >> 1);
      rd[2] = (((rs[0] >> (8 * (2 % 4))) & 0xFF) << 23) |
              (((rs[0] >> (8 * (2 % 4))) & 0xFF) << 15) |
              (((rs[0] >> (8 * (2 % 4))) & 0xFF) << 7) |
              (((rs[0] >> (8 * (2 % 4))) & 0xFF) >> 1);
      rd[3] = (((rs[0] >> (8 * (3 % 4))) & 0xFF) << 23) |
              (((rs[0] >> (8 * (3 % 4))) & 0xFF) << 15) |
              (((rs[0] >> (8 * (3 % 4))) & 0xFF) << 7) |
              (((rs[0] >> (8 * (3 % 4))) & 0xFF) >> 1);
      ;
      ...
      asm volatile(".word 0xd0380010" ::: "memory");
