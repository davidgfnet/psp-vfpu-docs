...
int run_vt4444_q(struct test_error_info *errlist,
  ...
  for (unsigned i = 0; i < 128; i++) {
    ...
    pfxinfo->rd_tested = 1;
    {
      ...
      rd[0] = ((rs[0 * 2 + 0] >> 4) & 0x0000000F) |
              ((rs[0 * 2 + 0] >> 8) & 0x000000F0) |
              ((rs[0 * 2 + 0] >> 12) & 0x00000F00) |
              ((rs[0 * 2 + 0] >> 16) & 0x0000F000) |
              ((rs[0 * 2 + 1] << 12) & 0x000F0000) |
              ((rs[0 * 2 + 1] << 8) & 0x00F00000) |
              ((rs[0 * 2 + 1] << 4) & 0x0F000000) |
              ((rs[0 * 2 + 1] << 0) & 0xF0000000);
      rd[1] = ((rs[1 * 2 + 0] >> 4) & 0x0000000F) |
              ((rs[1 * 2 + 0] >> 8) & 0x000000F0) |
              ((rs[1 * 2 + 0] >> 12) & 0x00000F00) |
              ((rs[1 * 2 + 0] >> 16) & 0x0000F000) |
              ((rs[1 * 2 + 1] << 12) & 0x000F0000) |
              ((rs[1 * 2 + 1] << 8) & 0x00F00000) |
              ((rs[1 * 2 + 1] << 4) & 0x0F000000) |
              ((rs[1 * 2 + 1] << 0) & 0xF0000000);
      ;
      unsigned int *rd_final = &rd[0]; // No dst prefix
      asm volatile(".word 0xdc000039" ::: "memory");
      asm volatile(".word 0xd0598090" ::: "memory");
